        ...
        <>
            <Head title="Welcome">
                <meta
                    ...
                    name="description"
                    content="Ledgerly is a mobile-first personal lending and relationship ledger."
                />
            </Head>
                    ...
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 font-medium">
                                Your relationship ledger, simplified
                            </h1>
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                Ledgerly helps you manage personal lending
                                relationships through a unified timeline of
                                loans, repayments, and reminders.
                            </p>
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                    ...
                                    <span>
                                        Track contacts and outstanding balances
                                    </span>
                                </li>
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                    ...
                                    <span>
                                        Record loans, repayments, and reminders
                                    </span>
                                </li>
                            </ul>
                        ...
                        <div className="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            <div className="flex h-full flex-col items-center justify-center gap-6 p-10">
                                <AppLogoIcon className="size-24 fill-current text-[#F53003] dark:text-[#F61500]" />
                                <p className="text-3xl font-semibold tracking-tight text-[#1b1b18] dark:text-[#EDEDEC]">
                                    Ledgerly
                                </p>
                                <p className="max-w-xs text-center text-sm text-[#706f6c] dark:text-[#A1A09A]">
                                    A calm, trustworthy ledger for personal
